...
<head>
    ...
    <link href={{URL::asset("users/css/styles.css")}} rel="stylesheet" />
</head>
<body id="page-top">
<!-- Navigation-->
...
<!-- Contact form JS-->
<script src={{URL::asset("users/assets/mail/jqBootstrapValidation.js")}}></script>
<script src={{URL::asset("users/assets/mail/contact_me.js")}}"assets/mail/contact_me.js"></script>
<!-- Core theme JS-->
<script src={{URL::asset("users/js/scripts.js")}}></script>
</body>
</html>
